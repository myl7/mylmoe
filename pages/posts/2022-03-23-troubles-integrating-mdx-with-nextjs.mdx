...
export const meta = {
  ...
  pubDate: '2022-03-23',
  updDate: '2022-03-23',
  excerpt: 'Solution to use remark/rehype plugins with JSX/TSX and use dynamic import to collect metadata from MDX posts. Remove rehype-raw when using MDX. Ignore CSS for esbuild.',
