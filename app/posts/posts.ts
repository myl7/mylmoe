...
import p0Src from '@/posts/open-source-desktop-show.md?raw'
import p1Src from '@/posts/aria2-socks-proxy-trouble.md?raw'
import p2Src from '@/posts/raspi-headless-init.md?raw'
import p3Src from '@/posts/mylmoe-demo.md?raw'
import p4Src from '@/posts/hacks-for-mdx-md-in-nextjs.md?raw'
import p5Src from '@/posts/tree-shaking-on-object-exports.md?raw'

import p0i0 from '@/images/open-source-desktop-show/general.png'
import p0i1 from '@/images/open-source-desktop-show/empty.png'
import p0i2 from '@/images/open-source-desktop-show/wallpaper_switcher.png'
import p0i3 from '@/images/open-source-desktop-show/statistics.png'
import p0i4 from '@/images/open-source-desktop-show/clipboard_history.png'
import p0i5 from '@/images/open-source-desktop-show/datetime.png'
import p0i6 from '@/images/open-source-desktop-show/actions.png'
import p3i0 from '@/images/pixiv_86286793_p0.jpg'
