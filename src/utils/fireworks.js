...
export const handleTap = (filter, canvasEl) => e => {
...
export const handleResize = canvasEl => debounce(() => {
...
export const tap = () => ('ontouchstart' in window || navigator.msMaxTouchPoints) ? 'touchstart' : 'mousedown'
