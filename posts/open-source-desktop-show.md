...
![general](../public/images/open_source_desktop_show/general.png)

空置效果：

![empty](../public/images/open_source_desktop_show/empty.png)

系统性能数据界面：

![statistics](../public/images/open_source_desktop_show/statistics.png)

日期时间界面：

![datetime](../public/images/open_source_desktop_show/datetime.png)

壁纸自动切换界面：

![wallpaper switcher](../public/images/open_source_desktop_show/wallpaper_switcher.png)

历史剪切板界面：

![clipboard history](../public/images/open_source_desktop_show/clipboard_history.png)

被收纳的操作的界面：

![more actions](../public/images/open_source_desktop_show/actions.png)
